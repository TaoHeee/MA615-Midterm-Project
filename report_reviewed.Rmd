...
Basically, for data cleaning and wrangling, we divide into three parts. First, we clean the two data sets separately. Then, we do the normalization to make sure that the common column in two data sets is encoding in the same way. Then we inner join the two data sets to generate the final data we will use in our further analysis. And below are the details about how we tidy up our data. 
